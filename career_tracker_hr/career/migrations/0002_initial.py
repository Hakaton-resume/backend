...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='vacancy',
            name='skills',
            field=models.ManyToManyField(help_text='Выберите навыки', related_name='vacancy_skill', through='career.SkillVacancy', to='career.skill', verbose_name='Навыки'),
        ),
        migrations.AddField(
            model_name='vacancy',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='skill',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='career.skill', verbose_name='Навык'),
        ),
        migrations.AddField(
            model_name='skillvacancy',
            name='vacancy',
        ...
        migrations.AddField(
            model_name='favourite',
            name='vacancy',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vacancy', to='career.vacancy', verbose_name='Вакансия'),
        ),
    ]
